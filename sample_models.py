...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for i in range(recur_layers-1):
        rnn = GRU(units, return_sequences=True, implementation = 2)(rnn)
        rnn = BatchNormalization()(rnn)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    bn_bi = BatchNormalization()(bidir_rnn1)
    #
    bidir_rnn2 = Bidirectional(GRU(units,
        return_sequences=True, implementation=2, name='rnn1'), merge_mode = 'concat')(bn_bi)
    bn_bi2 = BatchNormalization()(bidir_rnn2)
    #
    time_dense = TimeDistributed(Dense(output_dim))(bn_bi2)
